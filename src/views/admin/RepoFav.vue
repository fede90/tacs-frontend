...
export default {
  ...
  data() {
    return {
      ...
      fields: [
          ...
          { key: 'registerDate', label: 'Registered', sortable: true, class: 'text-center' },
  ...
  methods: {
    ...
    info(item, index, button) {
      ...
      api.getUserAmount(item.id).then(response=>{
        this.infoModal.content= "User amount: "+response.data.data.userAmount
      }).catch(e=>{
