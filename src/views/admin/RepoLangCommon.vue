    ...
    <div class="repo-lang-common">
        ...
        <b-container >
            <b-row align-h="center"> 
                ...
                <b-col align-self="center" cols="auto" >
                    <b-form-input size="sm" placeholder="Enter username" v-model="user1"></b-form-input>
                </b-col>
                <b-col align-self="center" cols="auto" > 
            ...
            <b-row align-h="center"> 
                ...
                <b-col align-self="center" cols="auto" >
                    <b-form-input size="sm" placeholder="Enter username" v-model="user2"></b-form-input>
                </b-col>
                <b-col align-self="center" cols="auto" > 
        ...
        <b-container >
            <b-row align-h="around"> 
                <b-col cols="4" v-show="viewUser1">
                    <b-card bg-variant="light" :header="'User 1: '+ user1" class="text-center">
                        <b-container>
                            <b-form-checkbox-group 
                                ...
                                stacked
                                >
                                <b-form-invalid-feedback :state="state1">Please select only one</b-form-invalid-feedback>
                                <b-form-valid-feedback :state="state1">Ok</b-form-valid-feedback>
                            </b-form-checkbox-group>
                        </b-container>
                    </b-card>
                </b-col>
                <b-col cols="4" v-show="viewUser2">
                    <b-card bg-variant="light" :header="'User 2: '+user2" class="text-center">
                        <b-container>
                            <b-form-checkbox-group 
                                v-model="value2"
                                ...
                                stacked
                                >
                                <b-form-invalid-feedback :state="state2">Please select only one</b-form-invalid-feedback>
                                <b-form-valid-feedback :state="state2">Ok</b-form-valid-feedback>
                            </b-form-checkbox-group>
                        </b-container>
                    </b-card>
                </b-col>
        ...
        <b-container v-show="state1 && state2">
            <b-row align-h="around"> 
                <b-col cols="4">
                    <b-card bg-variant="success" header="Common repositories" class="text-center">
                        <b-card-text v-for="repo of exampleRepoCommon">{{repo.name}}</b-card-text><!-- Esto puede marcar error, pero funciona -->
                    </b-card>
                </b-col>
                <b-col cols="4">
                    <b-card bg-variant="success" header="Common languages" class="text-center">
                        <b-card-text v-for="lang of exampleLangCommon">{{lang.name}}</b-card-text>
                    </b-card>
                </b-col>
            </b-row>
        </b-container>
