<template>
    <div class="user-data">
        ...
        <b-container v-show="oneUser">
            <b-row align-h="center"> 
                <b-card bg-variant="light" :header="responseUser.username" class="text-center">
                    <b-card-text><em class="font-weight-bold">Name: </em>{{responseUser.name}}</b-card-text>
                    <!-- <b-card-text><em class="font-weight-bold">Lastname: </em>{{responseUser.lastName}}</b-card-text> -->
                    <b-card-text><em class="font-weight-bold">Last access: </em>{{responseUser.lastAccessTime}}</b-card-text>
                    <b-card-text><em class="font-weight-bold">Favourite list count: </em>{{responseUser.contents.length}}</b-card-text>
                    <b-card-text><em class="font-weight-bold">Repositorie count: </em>{{sizeRepositories()}}</b-card-text>
        
                    <!--TODO: falta que devuelva el lenguaje que mas usa-->
                    <b-card-text><em class="font-weight-bold">Most used language: </em>{{responseUser.language}}</b-card-text>
                </b-card>
            </b-row>
        </b-container>
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                responseUser:{ /* esto es la forma que tendria la respuesta de nuestra api */
                    name:"",
                    lastname:"",
                    username:"",
                    lastAccessTime:"",
