  ...
  <div class="user-data">
    ...
    <b-container v-show="oneUser">
      <b-row align-h="center">
        <b-card
          bg-variant="light"
          :header="userExample.username"
          class="text-center"
        >
          <b-card-text
            ><em class="font-weight-bold">Name: </em
            >{{ userExample.name }}</b-card-text
          >
          <b-card-text
            ><em class="font-weight-bold">Lastname: </em
            >{{ userExample.lastname }}</b-card-text
          >
          <b-card-text
            ><em class="font-weight-bold">Favourite list count: </em
            >{{ userExample.favourite_size }}</b-card-text
          >
          <b-card-text
            ><em class="font-weight-bold">Repositorie count: </em
            >{{ userExample.repositorie_size }}</b-card-text
          >
          <b-card-text
            ><em class="font-weight-bold">Last access: </em
            >{{ userExample.last_access }}</b-card-text
          >
          <b-card-text
            ><em class="font-weight-bold">Most used language: </em
            >{{ userExample.language }}</b-card-text
          >
        </b-card>
      </b-row>
    </b-container>
